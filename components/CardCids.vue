    ...
    <div class="accordion" role="tablist">
      <b-card no-body class="mb-1">
        <b-card-header header-tag="header" class="p-1" role="tab">
          <b-button block v-b-toggle.chapters variant="info">
      ...
      <b-card no-body class="mb-1">
        <b-card-header header-tag="header" class="p-1" role="tab">
          <b-button block v-b-toggle.groups variant="info">
      ...
      <b-card no-body class="mb-1">
        <b-card-header header-tag="header" class="p-1" role="tab">
          <b-button block v-b-toggle.cids variant="info">
  ...
  methods: {
    ...
    async getChaptersCids(keyword) {
      try {
        ...
        this.notifyVue('top', 'center', `${e}`, 'danger');
      }
    },
